...
const vi = {
  ...
  'title.profile': 'Tài khoản & bảo mật',
  'title.progress': 'Tiến độ',
  ...
  'exam.readingDividerLabel': 'Điều chỉnh độ rộng bài đọc',
  'exam.readingDividerValue': '{percent}% chiều rộng cho bài đọc',
  ...
  'exam.writingFeedbackTitle': 'Nhận xét Writing',
  'exam.writingFeedbackLead':
    'Band từng task, bốn tiêu chí, và band tổng 1:2. Nhãn AI · tham khảo luôn đi cùng số.',
  'exam.writingPaperTitle': 'Đề và bài viết',
  ...
  'exam.markingPolling': 'Đang chờ kết quả chấm…',
  'exam.criterion.taskAchievement': 'Task Achievement (TA)',
  'exam.criterion.taskResponse': 'Task Response (TR)',
  'exam.criterion.coherenceAndCohesion': 'Coherence and Cohesion (CC)',
  'exam.criterion.lexicalResource': 'Lexical Resource (LR)',
  'exam.criterion.grammaticalRangeAndAccuracy': 'Grammatical Range and Accuracy (GRA)',
  'exam.criterion.fluencyAndCoherence': 'Fluency and Coherence (FC)',
  ...
  'exam.filterUnanswered': 'Chưa làm',
  'exam.filterCorrect': 'Đúng',
  'exam.aiAdvisory': 'AI · tham khảo',
  'exam.accuracy': 'Độ chính xác',
  'exam.fullTestAvailable': 'Kết quả khả dụng cho {ready}/{total} kỹ năng',
  'exam.overallNote': 'Điểm Overall sẽ hiển thị sau khi cả 4 kỹ năng có kết quả.',
  ...
  'dash.group.learning': 'Học tập',
  'dash.group.resources': 'Tài nguyên',
  ...
  'dash.nav.articles': 'Bài viết',
  'dash.nav.profile': 'Tài khoản & bảo mật',
  'dash.nav.aiAssistant': 'Trợ lý AI',
  'dash.nav.previewBadge': 'Xem trước',
  ...
  'dash.recent.seeAll': 'Xem tất cả',

  'dash.nextAction.title': 'Bước tiếp theo',
  'dash.nextAction.badge': 'Gợi ý từ AI',
  'dash.nextAction.defaultBody':
...
const en: Record<StringKey, string> = {
  ...
  'exam.readingDividerLabel': 'Resize reading passage',
  'exam.readingDividerValue': '{percent}% width for reading passage',
  ...
  'exam.writingFeedbackTitle': 'Writing feedback',
  'exam.writingFeedbackLead':
    'Each task band, the four criteria, and the combined 1:2 band. Every number is labelled AI · advisory.',
  'exam.writingPaperTitle': 'The paper and your essays',
  'exam.writingPaperLead': 'The prompt, any figure, and what you submitted.',
  'exam.writingEssayTitle': 'Your essay',
  'exam.writingEmptyEssay': 'No submission for this task.',
  'exam.writingWaitingBody':
    'Task 1 and Task 2 are marked in turn. This page updates when they finish.',
  'exam.seeFeedback': 'See feedback',
  'exam.statWordsTask': 'Task {number} words',
  'exam.wordsOfMin': '{count}/{min} words',
  'exam.markingPolling': 'Waiting for marking…',
  'exam.criterion.taskAchievement': 'Task Achievement (TA)',
  'exam.criterion.taskResponse': 'Task Response (TR)',
  'exam.criterion.coherenceAndCohesion': 'Coherence and Cohesion (CC)',
  'exam.criterion.lexicalResource': 'Lexical Resource (LR)',
  ...
  'exam.criterion.pronunciation': 'Pronunciation',
  'exam.advisory.emptyOrNotEnglish':
    'No assessable English was submitted — band 0 on every criterion.',
  ...
  'exam.filterUnanswered': 'Unanswered',
  'exam.filterCorrect': 'Correct',
  ...
  'dash.nav.articles': 'Articles',
  'dash.nav.profile': 'Account & security',
  'dash.nav.aiAssistant': 'AI Assistant',
  'dash.nav.previewBadge': 'Preview',
  ...
  'dash.recent.seeAll': 'View all',

  'dash.nextAction.title': 'Next step',
  'dash.nextAction.badge': 'AI Coaching',
  'dash.nextAction.defaultBody':
    'Start with Reading or Listening — both scored against answer keys with immediate results.',
  'dash.nextAction.cta': 'Start practising',
